...
\usepackage{csquotes}
\usepackage[backend=biber,maxbibnames=10,maxcitenames=4,maxalphanames=4,style=alphabetic,isbn=false]{biblatex}
...
% If this is enabled, the folder doesn't need to be specified for each image in \includegraphics, i.e \includegraphics{picturename}
% \graphicspath{./img} 
