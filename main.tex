\IfFileExists{git.gen}{\input{git.gen}}{}
\IfFileExists{wc.gen}{\input{wc.gen}}{}
\PassOptionsToPackage{final}{graphicx}
\documentclass[frontopenright,draft,twoside,openright]{dmathesis}
\input{preamble}
...
%\researchgroup{CPT or Stats or whomever}
\pagenumbering{roman}
\maketitlepage*
